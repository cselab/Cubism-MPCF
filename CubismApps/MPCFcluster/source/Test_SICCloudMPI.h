...
class Test_SICCloudMPI :
    public Test_SICCloud<TGrid,TStepper,TSlice,TSubdomain>,
...
public:
    Test_SICCloudMPI(MPI_Comm comm, ArgumentParser& _parser) :
        ...
        Test_SICCloud<TGrid,TStepper,TSlice,TSubdomain>(_parser),
...
protected:
    ...
    virtual void _setup_parameter()
    {
        ...
        Test_SICCloud<TGrid,TStepper,TSlice,TSubdomain>::_parameter_sic_cloud();
    }
