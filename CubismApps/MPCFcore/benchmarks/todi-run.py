...
print 'usage: python todi-run.py gcc <desired-time-in-minutes> <footprint-per-thread-in-megabytes>'
...
module load PrgEnv-gnu ; export OMP_NUM_THREADS=16 ; "

if re.search("gcc", stage) != None:
	run.run("", tdesired_seconds, "16.8", "1.875", footprint_megabytes, common , "./todi-exec-gcc461/", nodedata+"-gcc461", "")
