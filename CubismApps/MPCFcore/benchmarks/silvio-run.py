...
print 'usage: python silvio-run.py gcc <desired-time-in-minutes> <footprint-per-thread-in-megabytes>'
...
if re.search("gcc", stage) != None:
	run.run("", tdesired_seconds, "54.4", "2.375", footprint_megabytes, common , "./silvio-exec-gcc461/", nodedata+"-gcc461", "")
	
#if re.search("icc", stage) != None:
#	run.run("", tdesired_seconds, "17.6", "2.", footprint_megabytes, common + "  source /opt/intel/composerxe/bin/compilervars.sh intel64; ", "./silvio-exec-icc121/", nodedata+"-icc121", "")
