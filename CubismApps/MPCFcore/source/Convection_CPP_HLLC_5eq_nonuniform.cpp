...
// NOTE:
// coefficients minus correspond to the following sketch:
// |  a  |  b  |  c -|+ d  |  e  |  f  |
// (from the 'view' of the cell face)
// Therefore, coefficients evaluated in cell c at -| correspond to location
// x_{i+1/2} in that cell (fom the 'view' of the cell center) and vice versa in
// cell d.  (Hence, when this method is called from the higher layers, the
// xcoeffs_minus (view from face) take the values of the Block_t::WENO::plus
// (view from cell center) coefficients.
void Convection_CPP_HLLC_5eq_nonuniform::compute_nonuniform(const Real * const srcfirst, const int srcfloats, const int rowsrcs, const int slicesrcs,
        ...
        const CoeffsWENO_Block_t& xcoeffs_minus, const CoeffsWENO_Block_t& xcoeffs_plus,
        const CoeffsWENO_Block_t& ycoeffs_minus, const CoeffsWENO_Block_t& ycoeffs_plus,
        const CoeffsWENO_Block_t& zcoeffs_minus, const CoeffsWENO_Block_t& zcoeffs_plus,
...
// Methods
///////////////////////////////////////////////////////////////////////////////
void Convection_CPP_HLLC_5eq_nonuniform::_xweno_minus(const InputSOA& _in, TempSOA& _out, const CoeffsWENO_Block_t& coeffs)
{
...
void Convection_CPP_HLLC_5eq_nonuniform::_xweno_pluss(const InputSOA& _in, TempSOA& _out, const CoeffsWENO_Block_t& coeffs)
{
    const Real* const c00 = &coeffs.c[0][0];
    const Real* const c01 = &coeffs.c[1][0];
    const Real* const c02 = &coeffs.c[2][0];
...
void Convection_CPP_HLLC_5eq_nonuniform::_yweno_minus(const InputSOA& _in, TempSOA& _out, const CoeffsWENO_Block_t& coeffs)
{
    const Real* const c00 = &coeffs.c[0][0];
    const Real* const c01 = &coeffs.c[1][0];
    const Real* const c02 = &coeffs.c[2][0];
...
void Convection_CPP_HLLC_5eq_nonuniform::_yweno_pluss(const InputSOA& _in, TempSOA& _out, const CoeffsWENO_Block_t& coeffs)
{
    const Real* const c00 = &coeffs.c[0][0];
    const Real* const c01 = &coeffs.c[1][0];
    const Real* const c02 = &coeffs.c[2][0];
...
void Convection_CPP_HLLC_5eq_nonuniform::_zweno_minus(const int r, const RingInputSOA& in, TempSOA& out, const int sliceid, const CoeffsWENO_Block_t& coeffs)
{
    static const int L = InputSOA::PITCH;
...
void Convection_CPP_HLLC_5eq_nonuniform::_zweno_pluss(const int r, const RingInputSOA& in, TempSOA& out, const int sliceid, const CoeffsWENO_Block_t& coeffs)
{
    static const int L = InputSOA::PITCH;
...
void Convection_CPP_HLLC_5eq_nonuniform::_xflux_nonuniform(const int relid, const CoeffsWENO_Block_t& coeffs_minus, const CoeffsWENO_Block_t& coeffs_plus, const Real* const invh)
{
#ifndef _A2_A2R2_R_
...
void Convection_CPP_HLLC_5eq_nonuniform::_yflux_nonuniform(const int relid, const CoeffsWENO_Block_t& coeffs_minus, const CoeffsWENO_Block_t& coeffs_plus, const Real* const invh)
{
#ifndef _A2_A2R2_R_
...
void Convection_CPP_HLLC_5eq_nonuniform::_zflux_nonuniform(const int relid, const bool evalXtra, const int sliceid, const CoeffsWENO_Block_t& coeffs_minus, const CoeffsWENO_Block_t& coeffs_plus, const Real invh)
{
#ifndef _A2_A2R2_R_
