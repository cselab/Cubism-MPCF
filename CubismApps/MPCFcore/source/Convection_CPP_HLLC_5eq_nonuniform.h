...
protected:
    ...
    void _xweno_minus(const InputSOA& in, TempSOA& out, const CoeffsWENO_Block_t& coeffs);
    void _xweno_pluss(const InputSOA& in, TempSOA& out, const CoeffsWENO_Block_t& coeffs);
    void _yweno_minus(const InputSOA& in, TempSOA& out, const CoeffsWENO_Block_t& coeffs);
    void _yweno_pluss(const InputSOA& in, TempSOA& out, const CoeffsWENO_Block_t& coeffs);
    void _zweno_minus(const int relid, const RingInputSOA& in, TempSOA& out, const int sliceid, const CoeffsWENO_Block_t& coeffs);
    void _zweno_pluss(const int relid, const RingInputSOA& in, TempSOA& out, const int sliceid, const CoeffsWENO_Block_t& coeffs);
    ...
    virtual void _xflux_nonuniform(const int relsliceid, const CoeffsWENO_Block_t& coeffs_minus, const CoeffsWENO_Block_t& coeffs_plus, const Real* const invh);
    virtual void _yflux_nonuniform(const int relsliceid, const CoeffsWENO_Block_t& coeffs_minus, const CoeffsWENO_Block_t& coeffs_plus, const Real* const invh);
    virtual void _zflux_nonuniform(const int relsliceid, const bool evalXtra, const int sliceid, const CoeffsWENO_Block_t& coeffs_minus, const CoeffsWENO_Block_t& coeffs_plus, const Real invh);
