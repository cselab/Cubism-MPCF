...
rm tmp00000.StreamerGridPointIterative.channel0; 
srun --ntasks=4 -c 1 ./hdf2ch -xpesize 1 -ypesize 1 -zpesize 4 -bpdx $nb -bpdy $nb -bpdz 8 -sim io -simdata $inputfile -outdata tmp -threshold $thrval -wtype_write $wt
rm tmp00000.StreamerGridPointIterative.channel0; 
srun --ntasks=8 -c 1 ./hdf2ch -xpesize 1 -ypesize 1 -zpesize 8 -bpdx $nb -bpdy $nb -bpdz 4 -sim io -simdata $inputfile -outdata tmp -threshold $thrval -wtype_write $wt
