...
srun --ntasks=1 -c 1 ./hdf2ch -xpesize 1 -ypesize 1 -zpesize 1 -bpdx 16 -bpdy 16 -bpdz 16 -sim io -simdata $inputfile -outdata tmp -threshold $thrval -wtype_write $wt
rm tmp00000.StreamerGridPointIterative.channel0; 
srun --ntasks=2 -c 1 ./hdf2ch -xpesize 1 -ypesize 1 -zpesize 2 -bpdx 16 -bpdy 16 -bpdz  8 -sim io -simdata $inputfile -outdata tmp -threshold $thrval -wtype_write $wt
rm tmp00000.StreamerGridPointIterative.channel0; 
srun --ntasks=4 -c 1 ./hdf2ch -xpesize 1 -ypesize 1 -zpesize 4 -bpdx 16 -bpdy 16 -bpdz  4 -sim io -simdata $inputfile -outdata tmp -threshold $thrval -wtype_write $wt
rm tmp00000.StreamerGridPointIterative.channel0; 
srun --ntasks=8 -c 1 ./hdf2ch -xpesize 1 -ypesize 1 -zpesize 8 -bpdx 16 -bpdy 16 -bpdz  2 -sim io -simdata $inputfile -outdata tmp -threshold $thrval -wtype_write $wt
