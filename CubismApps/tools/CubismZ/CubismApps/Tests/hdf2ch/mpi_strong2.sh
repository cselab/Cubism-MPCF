...
srun --ntasks=1 -c 1 ./hdf2ch -xpesize 1 -ypesize 1 -zpesize 1 -bpdx $nb -bpdy $nb -bpdz 32 -sim io -simdata $inputfile -outdata tmp -threshold $thrval -wtype_write $wt
rm tmp00000.StreamerGridPointIterative.channel0; 
srun --ntasks=2 -c 1 ./hdf2ch -xpesize 1 -ypesize 1 -zpesize 2 -bpdx $nb -bpdy $nb -bpdz 16 -sim io -simdata $inputfile -outdata tmp -threshold $thrval -wtype_write $wt
rm tmp00000.StreamerGridPointIterative.channel0; 
srun --ntasks=4 -c 1 ./hdf2ch -xpesize 1 -ypesize 2 -zpesize 2 -bpdx $nb -bpdy 16 -bpdz 16 -sim io -simdata $inputfile -outdata tmp -threshold $thrval -wtype_write $wt
rm tmp00000.StreamerGridPointIterative.channel0; 
srun --ntasks=8 -c 1 ./hdf2ch -xpesize 2 -ypesize 2 -zpesize 2 -bpdx 16 -bpdy 16 -bpdz 16 -sim io -simdata $inputfile -outdata tmp -threshold $thrval -wtype_write $wt
