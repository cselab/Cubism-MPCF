...
#RES=`echo $2 | sed 's/\// /g' | awk '{print $NF}'`_sz_res.txt
RES=`echo $2 | sed 's/\// /g' | awk '{print $NF}'`_sz148_res.txt
...
for PARAM in 0 0.00000001 0.0000001 0.000001 0.000010 0.000100 0.001000 0.010000 0.100000 1 2 5 10 50 100
do
