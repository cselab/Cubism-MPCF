...
struct FluidBlock
{
	...
	typedef FluidElement element_type;
        ...
        FluidElement __attribute__((__aligned__(CUBISM_ALIGNMENT)))
...
//};
//template<> inline Real StreamerGridPointIterative::operate<0>(const FluidElement& e) { return e.uvwp; }
//template<> inline Real StreamerGridPointIterative::operate<1>(const FluidElement& e) { return e.v; }
//template<> inline Real StreamerGridPointIterative::operate<2>(const FluidElement& e) { return e.w; }
//template<> inline Real StreamerGridPointIterative::operate<3>(const FluidElement& e) { return e.p; }
