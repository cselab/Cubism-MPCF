...
commonflags = " omp=1 -j8 config=release precdiv=-1 vtk=0 cvt=1 hdf=0 "
tgcc = create.create_executables("source /etc/profile.d/modules.sh; module purge ; module load gcc/4.6.1; ", 
		" CC=gcc" + commonflags, "gcc461", [" extra=\"-march=barcelona -mtune=barcelona\" ", " numa=1 "], "brutus-cvt-exec-gcc461")
