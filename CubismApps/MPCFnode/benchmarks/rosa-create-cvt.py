...
commonflags = " omp=1 -j8 config=release precdiv=-1 vtk=0 cvt=1 hdf=0 avx=1 align=32 "
tgcc = create.create_executables(" ", 
		" CC=gcc" + commonflags, "gcc461", [" extra=\"-march=bdver1 -mtune=bdver1\" ", " numa=1 "], "rosa-cvt-exec-gcc461")
