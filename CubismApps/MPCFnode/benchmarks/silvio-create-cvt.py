...
commonflags = " omp=1 -j8 config=release precdiv=-1 vtk=0 hdf=0 cvt=1 avx=1 align=32 "
tgcc = create.create_executables("", 
		" CC=gcc" + commonflags, "gcc461", [" numa=1 "], "silvio-exec-cvt-gcc461")
ticc = 0#create.create_executables("source /etc/profile.d/modules.sh; module purge ; module load intel/12; ", 
		#" CC=icc" + commonflags, "icc12", ["", " numa=1  "], "silvio-exec-icc12")
