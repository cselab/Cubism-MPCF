            ...
            for(int iz=0; iz<FluidBlock::sizeZ; iz++)
                for(int iy=0; iy<FluidBlock::sizeY; iy++)
                    for(int ix=0; ix<FluidBlock::sizeX; ix++)
                    {
                        ...
                        const Real pre_shock[3] = {1000,0,1000};//{10,0,1000};
                        ...
                        b(ix, iy, iz).rho      = (1-shock)*(0.0278*bubble+pre_shock[0]*(1-bubble));
                        b(ix, iy, iz).u        = 0;
                        b(ix, iy, iz).v        = 0;
                        b(ix, iy, iz).w        = 0;
                        
                        const double pressure  = (1-shock)*(0.0234*bubble+pre_shock[2]*(1-bubble));//pre_shock[2]*(1-shock);
