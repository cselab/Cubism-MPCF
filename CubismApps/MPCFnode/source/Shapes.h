...
public:
    ...
    static std::vector<shape> make_many(string filename, const bool verbose=true)
    {
...
public:
    ...
    void make_shapes(string filename, const bool verbose=true)
    {
        v_shapes = Tshape::make_many(filename, verbose);
