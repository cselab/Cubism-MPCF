...
class Test_Advection : public virtual Test_Cloud<TGrid,TStepper,TSlice,TSubdomain>
{
public:
    Test_Advection(ArgumentParser& P) :
        Test_SteadyState<TGrid,TStepper,TSlice,TSubdomain>(P),
        Test_Cloud<TGrid,TStepper,TSlice,TSubdomain>(P)
    { }
...
void Test_Advection<TGrid,TStepper,TSlice,TSubdomain>::_ic()
{
    if (this->isroot)
...
template <typename TGrid, typename TStepper, template <typename> class TSlice, template <typename> class TSubdomain>
void Test_Advection<TGrid,TStepper,TSlice,TSubdomain>::_parameter_advection()
{
...
template <typename TGrid, typename TStepper, template <typename> class TSlice, template <typename> class TSubdomain>
void Test_Advection<TGrid,TStepper,TSlice,TSubdomain>::_set_shape_advection_ic()
{
...
template <typename TGrid, typename TStepper, template <typename> class TSlice, template <typename> class TSubdomain>
void Test_Advection<TGrid,TStepper,TSlice,TSubdomain>::_set_collinear_advection_ic()
{
    const double G1 = 1.0/(Simulation_Environment::GAMMA1-1.0);
    const double G2 = 1.0/(Simulation_Environment::GAMMA2-1.0);
    const double F1 = Simulation_Environment::GAMMA1*Simulation_Environment::PC1;
...
template <typename TGrid, typename TStepper, template <typename> class TSlice, template <typename> class TSubdomain>
void Test_Advection<TGrid,TStepper,TSlice,TSubdomain>::_set_normal_advection_ic()
{
    const double G1 = 1.0/(Simulation_Environment::GAMMA1-1.0);
    const double G2 = 1.0/(Simulation_Environment::GAMMA2-1.0);
    const double F1 = Simulation_Environment::GAMMA1*Simulation_Environment::PC1;
