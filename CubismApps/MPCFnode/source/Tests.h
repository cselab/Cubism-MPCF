...
#elif defined(_BCLABSICCLOUD_LEFTREFLECT_SYMMETRIC_)
typedef BlockLabSICCloud_LeftReflect_Symmetric<Block_t, std::allocator> Lab;

#elif defined(_BCLABSICCLOUD_LEFTREFLECT_SYMMETRIC_TENSORIAL_)
typedef BlockLabSICCloud_LeftReflect_Symmetric_StressTensorial<Block_t, std::allocator> Lab;
