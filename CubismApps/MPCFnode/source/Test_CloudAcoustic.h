...
class Test_CloudAcoustic: public Test_Cloud<TGrid,TStepper,TSlice,TSubdomain>
{
public:
...
protected:
    ...
    {
        Test_Cloud<TGrid,TStepper,TSlice,TSubdomain>::_setup_parameter();
...
void Test_CloudAcoustic<TGrid,TStepper,TSlice,TSubdomain>::_ic_single_phase()
{
    if (this->isroot)
...
template <typename TGrid, typename TStepper, template <typename> class TSlice, template <typename> class TSubdomain>
void Test_CloudAcoustic<TGrid,TStepper,TSlice,TSubdomain>::_ic_multi_phase()
{
    if (this->isroot)
        std::cout << "Cloud Initial condition..." << std::endl;
...
template <typename TGrid, typename TStepper, template <typename> class TSlice, template <typename> class TSubdomain>
void Test_CloudAcoustic<TGrid,TStepper,TSlice,TSubdomain>::_parameter_cloud_acoustics()
{
    Lab dummy;
